...
export default function AdminTools() {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-xl shadow-lg border border-slate-200/50 p-8">
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-5">
            <div className="bg-gradient-to-br from-blue-600 via-blue-700 to-indigo-700 p-4 rounded-xl shadow-xl">
          ...
          <div className="flex items-center space-x-4">
            ...
            <div className="h-12 w-12 bg-gradient-to-br from-blue-600 to-indigo-700 rounded-xl flex items-center justify-center shadow-lg ring-2 ring-blue-100">
      ...
      <div className="bg-gradient-to-r from-amber-50 to-orange-50 border border-amber-200/50 rounded-xl shadow-sm" />
                ...
                <form onSubmit={handleCreateUser} className="space-y-4">
                  ...
                  <div className="flex items-center space-x-2 p-3 bg-blue-50 rounded-lg">
                    ...
                    <Label htmlFor="autoRestore" className="text-sm text-blue-700">
                      Conserver ma session superadmin (recommandé)
                    </Label>
                  </div>
      ...
      {/* Executive Users Management Table */}
            ...
            <Table className="divide-y divide-slate-200">
              <TableHeader className="bg-slate-50/80">
                <TableRow className="border-b border-slate-200/70">
                  <TableHead className="font-semibold text-slate-700 py-4 px-6">Utilisateur</TableHead>
                  <TableHead className="font-semibold text-slate-700 py-4 px-6">Rôle</TableHead>
                  <TableHead className="font-semibold text-slate-700 py-4 px-6">Ferme</TableHead>
                  <TableHead className="font-semibold text-slate-700 py-4 px-6">Contact</TableHead>
                  <TableHead className="font-semibold text-slate-700 py-4 px-6 text-right">Actions</TableHead>
                </TableRow>
              </TableHeader>
              <TableBody>
                {allUsers.map((userItem) => (
                  <TableRow key={userItem.id} className="border-b border-slate-100/50 hover:bg-slate-50/50 transition-colors">
                    <TableCell className="py-4 px-6">
                      <div className="flex items-center space-x-3">
                        ...
                        <div>
                          <div className="font-semibold text-slate-900">{userItem.nom}</div>
                          <div className="text-sm text-slate-500">{userItem.email}</div>
                        </div>
                      </div>
                    </TableCell>
                    <TableCell className="py-4 px-6">
                      <Badge className={`${getRoleBadgeColor(userItem.role)} font-medium px-3 py-1 rounded-full`}>
          ...
          <div className="space-y-4">
            <div className="flex flex-col gap-4 mt-4">
              <Button
                ...
                disabled={loading}
                className="bg-orange-600 hover:bg-orange-700 w-[99%] mx-auto"
              >
          ...
          <DialogHeader className="mobile-dialog-header">
            ...
            <DialogDescription>
              {pendingUserData && (
                ...
                Confirmez votre mot de passe pour conserver votre session superadmin :</>
              )}
            </DialogDescription>
          </DialogHeader>
